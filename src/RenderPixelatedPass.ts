...
export default class RenderPixelatedPass extends Pass {
  ...
  setSize(width: number, height: number) {
    ...
    ).uniforms.resolution.value.set(x, y, 1 / x, 1 / y);
  }
  ...
  material() {
    return new THREE.ShaderMaterial({
      ...
      fragmentShader: `
                ...
                float neighbourNormalEdgeIndicator(int x, int y, float depth, vec3 normal) {
                ...
                float normalEdgeIndicator() {
                    ...
                    indicator += neighbourNormalEdgeIndicator(0, -1, depth, normal);
                    indicator += neighbourNormalEdgeIndicator(0, 1, depth, normal);
                    indicator += neighbourNormalEdgeIndicator(-1, 0, depth, normal);
                    indicator += neighbourNormalEdgeIndicator(1, 0, depth, normal);
